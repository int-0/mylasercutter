...
#define Y_STEP_PINN     27
#define Y_DIR_PINN      28
...
#define X_DIR_PIN 22
#define X_MIN_PIN 25
#define X_ENABLE_PIN 24 //shared with X_enable_pin 
#define X_MAX_PIN -1
...
#define X_STEP_PIN      23
#define X_DIR_PIN       22
#define X_ENABLE_PIN    24 //same as E/X_enable_pin
#define X_MIN_PIN       25
#define X_MAX_PIN       -1
...
#define ALARM_PIN          -1
  ...
  #define LASER_PIN     12    // RAMPS 1.0
  #define FAN_PIN          11    // RAMPS 1.0

#else // RAMPS_V_1_1 or RAMPS_V_1_2
  #define LASER_PIN     10    // RAMPS 1.1
...
#define KNOWN_BOARD 1
    ...
    #define LASER_PIN    14    //changed @ rkoeppl 20110410
...
#define KNOWN_BOARD 1
    ...
    #define X_ENABLE_PIN    24
    #define X_MIN_PIN       5
    #define X_MAX_PIN       -1      //Y - Maxpin is 2
    ...
    #define Y_MIN_PIN       1
    #define Y_MAX_PIN       -1      //Z - Maxpin is 0

    //extruder pins
    #define LASER_PIN     4    // Laser
...
const int sensitive_pins[] = {0, 1, X_STEP_PIN, X_DIR_PIN, X_ENABLE_PIN, X_MIN_PIN, X_MAX_PIN, Y_STEP_PIN, Y_DIR_PIN, Y_ENABLE_PIN, Y_MIN_PIN, Y_MAX_PIN, LED_PIN, PS_ON_PIN, LASER_PIN, FAN_PIN};
